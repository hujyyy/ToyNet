 ...
 public int decoding(int packlength,byte[] tmpbuffer,int start_index,byte[] refer0,byte[] refer1){
    fft_test ft = new fft_test();
     ...
     for(int i=start_index;i<stop_index;i=i+samples_per_bit){
       ft.getfreq(tmpbuffer,i+truncate,32,freq);
    ...
    public void FSK(int num_pack,int samples_per_bit){
      ...
      int fft_winsize = 32;
        try {
            ...
            double frequencyOfSignal1 = sample_rate/fft_winsize*2;
            double frequencyOfSignal2 = sample_rate/fft_winsize*10;
...
//                    }
  ...
  public static void main(String[] args) throws IOException,InterruptedException{
    ...
    while (ProgramRun) {
      ...
      SoundCtrl98 sc = new SoundCtrl98();
      ...
      if (userChoice == 1) {
        ...
        sc.analysisAudio(num_pack,num_bits,samples_per_bit);
